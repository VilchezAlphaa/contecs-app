...
// Uso: import { icon } from './icons.js'; el.innerHTML = icon('arrow-left');
...
const ICONS = {
  ...
  'package-x':       `<path d="M12 22l-4-4"/><path d="M20.38 7.26A1 1 0 0 0 20 7h-4"/><path d="M4 7h4"/><path d="M21 11l-9-4-9 4"/><path d="M3 7v9a2 2 0 0 0 2 2h5"/><path d="M21 7v5"/><line x1="17" y1="17" x2="21" y2="21"/><line x1="21" y1="17" x2="17" y2="21"/>`,
  'package-check':   `<path d="M16 16l2 2 4-4"/><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14"/>`,
...
export function icon(name, cls = '') {
  ...
  return `<svg class="icon ${cls}" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">${paths}</svg>`;
}
